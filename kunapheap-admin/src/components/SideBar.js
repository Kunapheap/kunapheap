      ...
      <div className="w-full h-screen">
        ...
        <div onClick={handleActive}>
          <ul className="xl:text-xl lg:text-base flex flex-col gap-y-2 px-2 font-medium">
            <Link to="/dashboard"  >
              <li className={`hover:bg-blue-200 transition-all ease-out
            ...
            <Link to="/productlist" >
              ...
              hover:translate-x-2 flex gap-2 items-center rounded-md py-1 
               px-2 cursor-pointer ${active === "productlist" ? 'bg-blue-200' : ''}`}>
                <BsFillBagFill />
                <p>Product</p>
              </li>
            </Link>
            <Link to="/addproduct">
              <li className={`hover:bg-blue-200 transition-all ease-out 
              hover:translate-x-2 flex gap-2 items-center rounded-md py-1 
               px-2 cursor-pointer ${active === "addproduct" ? 'bg-blue-200' : ''}`}>
                <BsFillCartCheckFill />
                <p>Add Product</p>
              </li>
            </Link>
